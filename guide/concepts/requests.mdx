...
The ReturnPilot API accepts request bodies in JSON format.

When sending a request, you should include the following headers to indicate that you are sending and expecting JSON:
