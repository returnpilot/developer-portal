...
<ResponseField name="status" type="integer" required>
    A [Status](/guide/enums/shipment-statuses) enum representing the status of the order.
</ResponseField>

<ResponseField name="price" type="decimal">
    The total cost for shipping in your local currency.
</ResponseField>

<ResponseField name="carrier" type="string">
    The name of the provider handling the return shipment.
</ResponseField>

<ResponseField name="return_url" type="string" required>
    The URL used to schedule a return shipment.
</ResponseField>
