...
<ResponseField name="phone" type="string" required>
    The contact number for the address formatted using the [E.164 standard](/guide/concepts/formatting#phone-numbers).
</ResponseField>
...
<ResponseField name="country" type="integer" required>
    A [Country](/guide/enums/countries) enum representing the country of the address.
</ResponseField>
